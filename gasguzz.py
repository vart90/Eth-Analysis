...
if __name__ == "__main__":
    ...
    mrb = my_bucket_resource.Object(s3_bucket,'eth_' + dt + '/avg_gprice.txt')
    mrb.put(Body=json.dumps(average_gas_price.take(100)))               
    mrb1 = my_bucket_resource.Object(s3_bucket,'eth_' + dt + '/avg_gused.txt')
    mrb1.put(Body=json.dumps(average_gas_used.take(100)))
